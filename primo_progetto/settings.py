...
SECRET_KEY = 'django-insecure-unomnf-891g*$hg3e!)ldz(seqw)spd5=tc$(-sg1h(+g%(s@r'
...
=======
                 os.path.join(BASE_DIR, 'templates'),os.path.join(BASE_DIR, 'seconda_app/templates/seconda_app')],
>>>>>>> f2e412a232a1b4de1c2e8f2565d5eed2324ddf85
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
